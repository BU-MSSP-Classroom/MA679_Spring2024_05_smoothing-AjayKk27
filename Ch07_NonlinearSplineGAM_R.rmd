...
#
#
training_data$Private<- ifelse(training_data$Private=='Yes',1,0)
test_data$Private<- ifelse(test_data$Private=='Yes',1,0)
gam_fit<- gam(Outstate~ perc.alumni+Grad.Rate, data=training_data)
plot.Gam(gam_fit)
```
